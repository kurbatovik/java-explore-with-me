...
(
    ...
    FOREIGN KEY (event_id) REFERENCES public.events (id) ON UPDATE NO ACTION ON DELETE NO ACTION,
    FOREIGN KEY (author_id) REFERENCES public.users (id) ON UPDATE NO ACTION ON DELETE NO ACTION
);

CREATE UNIQUE INDEX IF NOT EXISTS uk_comment_event_requester ON public.comments (event_id, author_id, comment);
